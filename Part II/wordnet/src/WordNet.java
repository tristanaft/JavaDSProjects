...
public class WordNet {
    ...
    final private HashMap<String, List<Integer>> stringToId;
    final private HashMap<Integer, String> idToString;
    ...
    public WordNet(String synsets, String hypernyms) {
        ...
        Digraph wordDigraph = new Digraph(allLines.length);
        ...
        for(String line : allLines2) {
            ...
            for(int i = 1; i < lineArr.length; ++i) {
                wordDigraph.addEdge(idx, Integer.parseInt(lineArr[i]));
            }
        }
        hyperFile.close();
